...
#SBATCH --mem=5GB
#SBATCH -t 2:00:00
#SBATCH --output=/projects/b1042/HartmannLab/PAL00/rgi/errout/rgi_%A_%a.out
#SBATCH --error=/projects/b1042/HartmannLab/PAL00/rgi/errout/rgi_%A_%a.err
#SBATCH -p short
#SBATCH --array=1-21%7
...
rgi main -i /projects/b1042/HartmannLab/PAL00/phage_files/${param_a}.filtered_sequences.phages_combined.fna -o /projects/b1042/HartmannLab/PAL00/rgi/${param_a} -t contig --clean -d wgs
